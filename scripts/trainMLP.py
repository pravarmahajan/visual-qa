...
def main():
    ...
    if args.language_only:
        model.add(Dense(args.num_hidden_units,
                        input_dim=word_vec_dim, init='uniform'))
    else:
        model.add(Dense(args.num_hidden_units, input_dim=img_dim +
                        word_vec_dim, init='uniform'))
    ...
    if args.language_only:
        ...
        model_file_name = '../models/mlp_num_hidden_units_' + \
            str(args.num_hidden_units) + '_num_hidden_layers_' + \
            str(args.num_hidden_layers)
